...
import com.example.systemrezerwacji.domain.code_module.Code;
...
import static com.example.systemrezerwacji.domain.salon_module.SalonValidationResult.*;
import static com.example.systemrezerwacji.domain.salon_module.ValidationError.*;
...
class SalonFacadeTest {
    ...
    public void should_create_salon() {
        ...
        when(validator.validate(any(CreatedNewSalonDto.class))).thenReturn(validationResult);
